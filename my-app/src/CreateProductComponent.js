...
class CreateProductComponent extends Component {
    ...
    render() {
        ...
        if(this.props.fileUploaded){
            showUpload = <Input type="file" style={{'display':'none'}} name="single-file" id="single-file" multiple  onChange={this.props.onCreateProductUpload.bind(this)} placeholder="Image" />
            showUpload = <label> Image selected </label>

        }else{
            showUpload = <Input type="file" name="single-file" id="single-file" multiple onChange={this.props.onCreateProductUpload.bind(this)} placeholder="Image" />
        }
